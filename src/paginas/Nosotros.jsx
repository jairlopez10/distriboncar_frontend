      ...
      <div className="separaheader contenedor">
        ...
        <div className="p-contactar">
            ...
            <div className="flex justify-around mt-12">
              ...
              <img className="imagenredsocial" src="/wa.webp" alt="imagen-whatsapp" onClick={() => window.open("xHola%20Delteo!%20Quisiera%20saber%20mas%20informacion%20sobre%20..")} />
